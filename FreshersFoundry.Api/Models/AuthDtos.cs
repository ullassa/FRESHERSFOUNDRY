...
public sealed record CreateJobRequest(string Title, string CompanyName, string CompanyLogoUrl, string Location, string JobType, string ExperienceLevel, string SalaryRange, string SkillTags, string Description, string ApplyLink);
public sealed record JobCreateResponse(Guid Id, string Title, string CompanyName, string CompanyLogoUrl, string Location, string JobType, string ExperienceLevel, string SalaryRange, string SkillTags, string Description, string ApplyLink, Guid PostedById, string Status, DateTime CreatedAt);
